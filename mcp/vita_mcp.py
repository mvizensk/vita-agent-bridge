...
TOOLS = [
    ...
    {
        "name": "vita_launch",
        "description": "Launch an app by title id (nine characters, e.g. RETROVITA). If another "
                       "app is running the shell shows a 'will close' dialog: confirm it with "
                       "vita_tap at 654,444.",
        "inputSchema": {
            "type": "object",
    ...
    },
    {
        ...
        "description": "List a directory on the console, read-only, e.g. ux0:data.",
        "inputSchema": {
            "type": "object",
    ...
    {
        "name": "vita_read_file",
        "description": "Read a file from the console, read-only. Text comes back inline; "
                       "anything else is saved locally and the path returned.",
        "inputSchema": {
            "type": "object",
    ...
    {
        "name": "vita_close_app",
        "description": "Close the foreground app. The screen returns to the system shell.",
        "inputSchema": {"type": "object", "properties": {}},
    },
    {
...
def _call(name, args):
    ...
    if name == "vita_launch":
        return text(cli.line(HOST, "launch " + args["title_id"]))
    if name == "vita_status":
    ...
    for raw in sys.stdin:
        ...
        if method == "initialize":
            result = {"protocolVersion": PROTOCOL,
                      "capabilities": {"tools": {}},
                      "serverInfo": {"name": "vita-agent-bridge", "version": "1.0.0"}}
